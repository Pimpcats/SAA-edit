...
export function setupVideoTab(containerId) {
    ...
    // ---- Local servers: let the app launch the ComfyUI / A1111 servers itself
    // (headless — it only starts the server, it never opens a browser page).
    // Point each backend at your existing launch script; optionally auto-start.
    {
