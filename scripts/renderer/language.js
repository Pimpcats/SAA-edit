...
export function updateLanguage(skipLoRA = false, skipRightClick = false) {
    ...
    // View List
    setDropdownLanguage('dropdown-view', [LANG.view_angle, LANG.view_camera, LANG.view_background, LANG.view_style, LANG.view_position || 'Position', LANG.view_expression || 'Expression', LANG.view_clothing || 'Clothing']);
...
export function updateSettings() {
    ...
    globalThis.viewList.updateDefaults(SETTINGS.view_angle, SETTINGS.view_camera, SETTINGS.view_background, SETTINGS.view_style, SETTINGS.view_position, SETTINGS.view_expression, SETTINGS.view_clothing);
